...
public class ImportProdutoOutput {
    
    public String importJobId;
    
    public ImportProdutoOutput() {
    }
    
    /** 
     * This constructor allows initialization of all fields, required and optional.
     */
    public ImportProdutoOutput(String importJobId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof ImportProdutoOutput)) {
            return false;
        }
        ImportProdutoOutput other = (ImportProdutoOutput) obj;
