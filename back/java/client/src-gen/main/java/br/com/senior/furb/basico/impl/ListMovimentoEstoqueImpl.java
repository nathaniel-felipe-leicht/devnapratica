 ...
 * 
 */
public class ListMovimentoEstoqueImpl {
	...
	public ListMovimentoEstoqueImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(MovimentoEstoque.PageRequest input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				BasicoConstants.DOMAIN, //
				BasicoConstants.SERVICE, //
				BasicoConstants.Commands.LIST_MOVIMENTO_ESTOQUE, //
	...
	*/
	public MovimentoEstoque.PagedResults listMovimentoEstoque(MovimentoEstoque.PageRequest input, long timeout) {
		...
		MovimentoEstoque.PagedResults output = DtoJsonConverter.toDTO(resultMessage.getContent(), MovimentoEstoque.PagedResults.class);
		if (output == null) {
	...
	*/
	public CompletableFuture<MovimentoEstoque.PagedResults> listMovimentoEstoqueRequest(MovimentoEstoque.PageRequest input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, MovimentoEstoque.PagedResults.class);
	}
