 ...
 * 
 */
public class ExportProdutoImpl {
	...
	public ExportProdutoImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(ExportProdutoInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				BasicoConstants.DOMAIN, //
				BasicoConstants.SERVICE, //
				BasicoConstants.Commands.EXPORT_PRODUTO, //
	...
	*/
	public ExportProdutoOutput exportProduto(ExportProdutoInput input, long timeout) {
		...
		ExportProdutoOutput output = DtoJsonConverter.toDTO(resultMessage.getContent(), ExportProdutoOutput.class);
		if (output == null) {
	...
	*/
	public CompletableFuture<ExportProdutoOutput> exportProdutoRequest(ExportProdutoInput input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, ExportProdutoOutput.class);
	}
