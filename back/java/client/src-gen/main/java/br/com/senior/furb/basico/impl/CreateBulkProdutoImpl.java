 ...
 * 
 */
public class CreateBulkProdutoImpl {
	...
	public CreateBulkProdutoImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(CreateBulkProdutoInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				BasicoConstants.DOMAIN, //
				BasicoConstants.SERVICE, //
				BasicoConstants.Commands.CREATE_BULK_PRODUTO, //
	...
	*/
	public CreateBulkProdutoOutput createBulkProduto(CreateBulkProdutoInput input, long timeout) {
		...
		CreateBulkProdutoOutput output = DtoJsonConverter.toDTO(resultMessage.getContent(), CreateBulkProdutoOutput.class);
		if (output == null) {
	...
	*/
	public CompletableFuture<CreateBulkProdutoOutput> createBulkProdutoRequest(CreateBulkProdutoInput input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, CreateBulkProdutoOutput.class);
	}
