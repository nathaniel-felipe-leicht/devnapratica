 ...
 * 
 */
public class ExportMovimentoEstoqueImpl {
	...
	public ExportMovimentoEstoqueImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(ExportMovimentoEstoqueInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				BasicoConstants.DOMAIN, //
				BasicoConstants.SERVICE, //
				BasicoConstants.Commands.EXPORT_MOVIMENTO_ESTOQUE, //
	...
	*/
	public ExportMovimentoEstoqueOutput exportMovimentoEstoque(ExportMovimentoEstoqueInput input, long timeout) {
		...
		ExportMovimentoEstoqueOutput output = DtoJsonConverter.toDTO(resultMessage.getContent(), ExportMovimentoEstoqueOutput.class);
		if (output == null) {
	...
	*/
	public CompletableFuture<ExportMovimentoEstoqueOutput> exportMovimentoEstoqueRequest(ExportMovimentoEstoqueInput input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, ExportMovimentoEstoqueOutput.class);
	}
