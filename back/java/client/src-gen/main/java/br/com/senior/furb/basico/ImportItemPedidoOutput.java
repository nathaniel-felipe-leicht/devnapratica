...
public class ImportItemPedidoOutput {
    
    public String importJobId;
    
    public ImportItemPedidoOutput() {
    }
    
    /** 
     * This constructor allows initialization of all fields, required and optional.
     */
    public ImportItemPedidoOutput(String importJobId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof ImportItemPedidoOutput)) {
            return false;
        }
        ImportItemPedidoOutput other = (ImportItemPedidoOutput) obj;
