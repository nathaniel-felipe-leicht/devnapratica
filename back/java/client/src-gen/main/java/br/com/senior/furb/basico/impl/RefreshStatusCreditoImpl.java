 ...
 * 
 */
public class RefreshStatusCreditoImpl {
	...
	public RefreshStatusCreditoImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(RefreshStatusCreditoInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				BasicoConstants.DOMAIN, //
				BasicoConstants.SERVICE, //
				BasicoConstants.Commands.REFRESH_STATUS_CREDITO, //
	...
	*/
	public RefreshStatusCreditoOutput refreshStatusCredito(RefreshStatusCreditoInput input, long timeout) {
		...
		RefreshStatusCreditoOutput output = DtoJsonConverter.toDTO(resultMessage.getContent(), RefreshStatusCreditoOutput.class);
		if (output == null) {
	...
	*/
	public CompletableFuture<RefreshStatusCreditoOutput> refreshStatusCreditoRequest(RefreshStatusCreditoInput input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, RefreshStatusCreditoOutput.class);
	}
