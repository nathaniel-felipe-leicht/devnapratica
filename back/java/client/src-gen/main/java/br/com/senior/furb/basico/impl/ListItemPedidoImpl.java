 ...
 * 
 */
public class ListItemPedidoImpl {
	...
	public ListItemPedidoImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(ItemPedido.PageRequest input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				BasicoConstants.DOMAIN, //
				BasicoConstants.SERVICE, //
				BasicoConstants.Commands.LIST_ITEM_PEDIDO, //
	...
	*/
	public ItemPedido.PagedResults listItemPedido(ItemPedido.PageRequest input, long timeout) {
		...
		ItemPedido.PagedResults output = DtoJsonConverter.toDTO(resultMessage.getContent(), ItemPedido.PagedResults.class);
		if (output == null) {
	...
	*/
	public CompletableFuture<ItemPedido.PagedResults> listItemPedidoRequest(ItemPedido.PageRequest input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, ItemPedido.PagedResults.class);
	}
