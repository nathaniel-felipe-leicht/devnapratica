 ...
 * 
 */
public class CreateBulkMovimentoEstoqueImpl {
	...
	public CreateBulkMovimentoEstoqueImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(CreateBulkMovimentoEstoqueInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				BasicoConstants.DOMAIN, //
				BasicoConstants.SERVICE, //
				BasicoConstants.Commands.CREATE_BULK_MOVIMENTO_ESTOQUE, //
	...
	*/
	public CreateBulkMovimentoEstoqueOutput createBulkMovimentoEstoque(CreateBulkMovimentoEstoqueInput input, long timeout) {
		...
		CreateBulkMovimentoEstoqueOutput output = DtoJsonConverter.toDTO(resultMessage.getContent(), CreateBulkMovimentoEstoqueOutput.class);
		if (output == null) {
	...
	*/
	public CompletableFuture<CreateBulkMovimentoEstoqueOutput> createBulkMovimentoEstoqueRequest(CreateBulkMovimentoEstoqueInput input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, CreateBulkMovimentoEstoqueOutput.class);
	}
