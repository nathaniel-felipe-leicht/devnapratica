...
public class ExportProdutoOutput {
    
    public String exportJobId;
    
    public ExportProdutoOutput() {
    }
    
    /** 
     * This constructor allows initialization of all fields, required and optional.
     */
    public ExportProdutoOutput(String exportJobId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof ExportProdutoOutput)) {
            return false;
        }
        ExportProdutoOutput other = (ExportProdutoOutput) obj;
