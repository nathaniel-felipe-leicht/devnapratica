 ...
 * 
 */
public class CreateBulkItemPedidoImpl {
	...
	public CreateBulkItemPedidoImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(CreateBulkItemPedidoInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				BasicoConstants.DOMAIN, //
				BasicoConstants.SERVICE, //
				BasicoConstants.Commands.CREATE_BULK_ITEM_PEDIDO, //
	...
	*/
	public CreateBulkItemPedidoOutput createBulkItemPedido(CreateBulkItemPedidoInput input, long timeout) {
		...
		CreateBulkItemPedidoOutput output = DtoJsonConverter.toDTO(resultMessage.getContent(), CreateBulkItemPedidoOutput.class);
		if (output == null) {
	...
	*/
	public CompletableFuture<CreateBulkItemPedidoOutput> createBulkItemPedidoRequest(CreateBulkItemPedidoInput input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, CreateBulkItemPedidoOutput.class);
	}
