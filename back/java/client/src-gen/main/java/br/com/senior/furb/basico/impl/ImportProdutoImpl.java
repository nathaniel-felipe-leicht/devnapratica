 ...
 * 
 */
public class ImportProdutoImpl {
	...
	public ImportProdutoImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(ImportProdutoInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				BasicoConstants.DOMAIN, //
				BasicoConstants.SERVICE, //
				BasicoConstants.Commands.IMPORT_PRODUTO, //
	...
	*/
	public ImportProdutoOutput importProduto(ImportProdutoInput input, long timeout) {
		...
		ImportProdutoOutput output = DtoJsonConverter.toDTO(resultMessage.getContent(), ImportProdutoOutput.class);
		if (output == null) {
	...
	*/
	public CompletableFuture<ImportProdutoOutput> importProdutoRequest(ImportProdutoInput input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, ImportProdutoOutput.class);
	}
