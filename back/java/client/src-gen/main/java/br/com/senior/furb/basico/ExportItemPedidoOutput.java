...
public class ExportItemPedidoOutput {
    
    public String exportJobId;
    
    public ExportItemPedidoOutput() {
    }
    
    /** 
     * This constructor allows initialization of all fields, required and optional.
     */
    public ExportItemPedidoOutput(String exportJobId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof ExportItemPedidoOutput)) {
            return false;
        }
        ExportItemPedidoOutput other = (ExportItemPedidoOutput) obj;
