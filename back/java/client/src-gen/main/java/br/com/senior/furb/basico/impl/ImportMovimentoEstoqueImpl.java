 ...
 * 
 */
public class ImportMovimentoEstoqueImpl {
	...
	public ImportMovimentoEstoqueImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(ImportMovimentoEstoqueInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				BasicoConstants.DOMAIN, //
				BasicoConstants.SERVICE, //
				BasicoConstants.Commands.IMPORT_MOVIMENTO_ESTOQUE, //
	...
	*/
	public ImportMovimentoEstoqueOutput importMovimentoEstoque(ImportMovimentoEstoqueInput input, long timeout) {
		...
		ImportMovimentoEstoqueOutput output = DtoJsonConverter.toDTO(resultMessage.getContent(), ImportMovimentoEstoqueOutput.class);
		if (output == null) {
	...
	*/
	public CompletableFuture<ImportMovimentoEstoqueOutput> importMovimentoEstoqueRequest(ImportMovimentoEstoqueInput input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, ImportMovimentoEstoqueOutput.class);
	}
